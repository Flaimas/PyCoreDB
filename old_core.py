...
class FileLoggerMixin:
    def log(self, message):
        print(f'[FILE]: Запись лога "{message}" в файл.')
        super().log(message)

class BaseEngine:
    def log(self, message):
        print(f'[ENGINE]: Базовый лог движка -> {message}')

class SmartDatabase(ConsoleLoggerMixin, FileLoggerMixin, Database, BaseEngine):
    pass

# =====================================================================
# ЦЕПОЧКА MRO ДЛЯ КЛАССА SmartDatabase:
#
# [1] SmartDatabase ->
# [2] ConsoleLoggerMixin ->
# [3] FileLoggerMixin ->
# [4] Database ->
# [5] BaseEngine ->
# [6] object
